...
let kv: productPieceData_t = {
  ...
  description:
    "Ultra-fast in-memory bey-value database built on Redis protocol for caching, queues, and session storage.",
  features: [
...
let graph: productPieceData_t = {
  ...
  description:
    "Powerful Cypher query language with visualization tool for model and query relationship.",
  features: ["Web-based query editor", "Visualize nodes and edges", "REST and Cypher API"],
  link: "/coming-soon.html",
  icon: "",
};
...
let nosql: productPieceData_t = {
  ...
  features: ["Dynamic schema support", "Rich query filters", "Scales horizontally"],
  link: "/coming-soon.html",
  icon: "",
};
...
let statichost: productPieceData_t = {
  ...
  features: ["Git integration", "Automatic HTTPS"],
  link: "/coming-soon.html",
  icon: "",
};
...
let backendhost: productPieceData_t = {
  ...
  description:
    "Run secure backend logic without managing infrastructure. Use REST endpoints, cron jobs, or event triggers.",
  features: ["Intergrate logging and analytics", "Automatic security enforcement"],
  link: "/coming-soon.html",
  icon: "",
};
...
let fullstack: productPieceData_t = {
  ...
  description:
    "Deploy full stack app with Server-Side Rendering, APIs, and static assets in one place.",
  features: ["Framework awareness (Next.js, SvelteKit)", "Custom domains & routing"],
  link: "/coming-soon.html",
  icon: "",
};
...
let trafficAnalytics: productPieceData_t = {
  ...
  features: ["Live pageview & session", "Device & Browser breakdown"],
  link: "/coming-soon.html",
  icon: "",
};
...
let funnel: productPieceData_t = {
  ...
  features: ["Custom funnel builder", "Custom Geal and event taggings", "Conversion rate insight"],
  link: "/coming-soon.html",
  icon: "",
};
...
let abtest: productPieceData_t = {
  ...
  description:
    "Run controlled experiment to compare UI. features ,or flows. Back decisions with real user behavior data.",
  features: [
...
let vault: productPieceData_t = {
  ...
  description:
    "Upload, store, and access files with role based sharing and automatic versioning. Designed for teams and apps.",
  features: ["Unlimited file types", "Access tokens with expiry", "File version history"],
  link: "/coming-soon.html",
  icon: "",
};
...
let bucket: productPieceData_t = {
  ...
  features: ["Custom domain mapping", "CORS control"],
  link: "/coming-soon.html",
  icon: "",
};
...
let stream: productPieceData_t = {
  ...
  description:
    "Capture user actions, telemetry, and system events in real time for further processing or export.",
  features: [
